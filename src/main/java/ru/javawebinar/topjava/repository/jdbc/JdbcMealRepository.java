...
public class JdbcMealRepository implements MealRepository {
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        List<Meal> meals = jdbcTemplate.query("SELECT * FROM meals WHERE user_id=? AND date_time" +
                " BETWEEN ? AND ? ORDER BY date_time DESC",ROW_MAPPER, userId,startDateTime,endDateTime);
        return CollectionUtils.isEmpty(meals) ? null : meals;
    }
}
